...
export const MyDocument: React.FC<Props> = ({  resultadoDominante, resultadoGrafica, resultado }) => {

  const getImagenes = (val: string | undefined) => {
    const valMin = val?.toLowerCase()
    switch (valMin) {
      case "+s":
        return "https://res.cloudinary.com/dpiwmbsog/image/upload/v1710806029/DevSphere/socializador1_okqhx6.jpg";
      case "+k":
        return "https://res.cloudinary.com/dpiwmbsog/image/upload/v1710806028/DevSphere/killer1_v16ejr.jpg";
      case "+e":
        return "https://res.cloudinary.com/dpiwmbsog/image/upload/v1710806028/DevSphere/explorador1_r1quel.jpg"
      case "+t":
        return "https://res.cloudinary.com/dpiwmbsog/image/upload/v1710806031/DevSphere/triunfador1_nxbsh7.jpg"
        default:
...
export const DownloadPdf: React.FC<Props> = ({ resultadoDominante, resultadoGrafica, resultado }) => (
  
    <PDFDownloadLink document={<MyDocument resultadoDominante={resultadoDominante} resultadoGrafica={resultadoGrafica} resultado={resultado}/>} fileName="resultado_test_jugador.pdf">
