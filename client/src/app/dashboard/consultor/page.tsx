...
const Page: React.FC = () => {
  ...
  // const adminToken = userConsultant?.token
  ...
  useEffect(() => {
    if (consultantToken) {
      const initFetch = async () => {
        setIsLoading(true);
        try {
          await fetchData(consultantToken);
          await fetchCompany(consultantToken);
          await fetchTests(consultantToken);
        } catch (error) {
  ...
  }, [fetchData, fetchCompany, fetchTests, consultantToken]);
  ...
  return (
    <section className="w-full md:w-[90%] h-screen flex flex-col justify-center items-center absolute md:relative left-3 md:left-0 ml-auto">
      <div className="md:min-h-[4rem] m-4 box-border mt-8 flex gap-4 justify-center items-center md:justify-end md:w-[90%] h-[40%] md:h-full mx-auto">
        ...
        <section className="flex flex-col justify-center items-center md:flex-row gap-4 space-y-[1rem] h-full">
        ...
        <section className="h-[20%] md:max-h-[10rem] md:h-[3rem] flex md:justify-end gap-6 items-center md:flex-row md:w-[50%]">
          <div className="md:h-full md:max-h-none">
          <SideBarButton
            href="/dashboard/consultor/createUser"
          ...
          <div className="md:h-full md:max-h-none">
          <SideBarButton
            href="/dashboard/consultor/createCompany"
            colorClass="bg-fuchsia_color mx-auto md:gap-2 text-white"
          ...
          <table className="w-full text-left text-sm whitespace-nowrap h-full p-2 mx-auto">
              ...
              <tbody className="w-full">
                {getVisibleConsultants()?.map((consultor) => (
                  <tr
                    key={consultor.id}
                    className="border-b dark:border-neutral-600 hover:bg-neutral-100 dark:hover:bg-neutral-600 w-full px-2"
                  >
                    <td className="w-[200px] h-[50px] border-x dark:border-neutral-600 break-words whitespace-normal font-bold">
                      <div className="flex justify-start items-center w-full p-2 min-w-[11rem] break-words whitespace-normal ">
                        {consultor.avatar ? (
                          <Image
